...
<p>
  Binary Sunrise built the Lock Breaker game as an Ad Supported game. This SERVICE is provided by Binary Sunrise at no
...
<p>
  ...
  Lock Breaker unless otherwise defined in this Privacy Policy.
</p>
...
<p>
  I want to inform you that whenever you use my Service, in a case of an error in the game I collect data and
  information (through third party products) on your phone called Log Data. This Log Data may include information such
  as your device Internet Protocol (“IP”) address, device name, operating system version, the configuration of the game
...
<p>
  This Service does not use these “cookies” explicitly. However, the game may use third party code and libraries that
